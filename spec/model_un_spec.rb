...
describe ModelUN do
  ...
  it "should be able to read the data hash" do
    ModelUN::STATE_NAMES.should_not == nil
    ModelUN::STATE_ABBR.should_not == nil
  end
  ...
  describe "states" do
    ...
    it "should return an abbreviation full country name for a country name with two words" do
      ...
      ModelUN.convert_state_name(country).should == 'CZE'
    end
  end
